...
<div class="container">
    ...
    <div class="mt-4 mb-3">
        <label for="sqrFt" class="font-weight-bold">How many square feet of tile do you want?
            <?php if (isset($invalidSqrFt)): ?>
                <span class="error">Please enter a valid number</span>
            <?php endif; ?>
        </label>
        <input id="sqrFt" name="sqrFt" type="text" placeholder="SqrFt" class="form-control input-md"
        <?php if (isset($sqrFt)): ?>
            value="<?= ($sqrFt) ?>"
        <?php endif; ?>>
    </div>
